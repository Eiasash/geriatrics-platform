  ...
  return (
    <>
      <div className={`min-h-screen bg-gray-50 ${language === 'he' ? 'rtl' : 'ltr'}`} dir={language === 'he' ? 'rtl' : 'ltr'}>
        ...
        {/* Sidebar */}
        <div className={`fixed inset-y-0 ${language === 'he' ? 'right-0' : 'left-0'} z-50 w-64 bg-white shadow-lg transform ${sidebarOpen ? 'translate-x-0' : language === 'he' ? 'translate-x-full' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0`}>

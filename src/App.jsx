...
const App = () => {
  ...
  // Comprehensive Board Review Questions Database (120+ questions)
  const boardQuestions = [
    // Dementia & Cognitive Disorders (Based on Chapter 59)
    {
      id: 'dem1',
      category: 'Dementia',
      question: '82-year-old woman with 6-month progressive memory loss, MMSE 22/30, MRI shows hippocampal atrophy. Most likely diagnosis?',
      options: ['Alzheimer disease', 'Vascular dementia', 'Lewy body dementia', 'Frontotemporal dementia'],
      answer: 0,
      explanation: 'Insidious onset with gradual progression and hippocampal atrophy are classic for Alzheimer disease.',
      hebrewQuestion: 'אישה בת 82 עם ירידה קוגניטיבית הדרגתית, MMSE 22/30, MRI מראה ניוון היפוקמפוס. האבחנה?'
    },
    {
      id: 'dem2',
      category: 'Dementia',

...
import EnhancedMedications from './components/EnhancedMedications';
import TrainingVideos from './components/TrainingVideos';
import NewsUpdates from './components/NewsUpdates';
import { Home, Calculator, FileText, Package, LogOut, Menu, X, Pill, ClipboardList, BarChart3, Shield, Printer, Users, BookOpen, FileCheck, Brain, GraduationCap, Video, Newspaper, Stethoscope } from 'lucide-react';
...
function AppContent() {
  ...
  const navigation = [
    ...
    { name: language === 'en' ? 'Enhanced Meds' : 'תרופות משופרות', href: '/enhanced-medications', icon: Stethoscope },
    ...
    { name: language === 'en' ? 'Case Studies' : 'מקרי בוחן', href: '/case-studies', icon: GraduationCap },
    { name: language === 'en' ? 'Training Videos' : 'סרטוני הדרכה', href: '/training-videos', icon: Video },
    { name: language === 'en' ? 'News & Updates' : 'חדשות ועדכונים', href: '/news-updates', icon: Newspaper },
        ...
        <div className="lg:pl-64">
          ...
          <main className="p-4 lg:p-8">
            <Routes>
              ...
              <Route path="/enhanced-medications" element={
                <EnhancedMedications language={language} />
              } />
